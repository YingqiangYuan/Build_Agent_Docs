...
- The **content lives at a separate `.md` URL** (`content_url` in each manifest entry, under `/assets/docs/...`). That IS fetchable and is what you WebFetch.
...
```
Read .claude/skills/antigravity-docs/references/docs-manifest.json
```
