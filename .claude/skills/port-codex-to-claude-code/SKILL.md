---
name: port-codex-to-claude-code
description: Port a project's Codex configuration to Claude Code, keeping the Codex files in place. Scans the project for Codex config artifacts, maps each to its Claude Code equivalent using the concept-mapping knowledge base, and creates or edits the matching Claude Code files. Use when migrating a repo from Codex to Claude Code.
...
Codex primary file or location and the Claude Code primary file or
...
field names, and `codex-docs` for the source. Do not migrate from
