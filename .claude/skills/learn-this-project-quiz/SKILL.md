...
2. Offer:
   ...
   > - **Open-ended mode**: tell me the topic and how many — e.g. `generate 5 harder questions about the doer/checker split` — and I'll generate fresh discussion-style questions in the same format, drawing on the project's docs and code.
   >
   > Say `go` to take it.
